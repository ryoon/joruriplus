...
function initTinyMCE(originalSettings) {
  var settings = {
    ...
    // Theme options
    theme_advanced_buttons1: "fontselect,fontsizeselect,separator,removeformat,separator,forecolor,backcolor,separator,",
    theme_advanced_buttons2: "bold,italic,underline,strikethrough,separator,justifyleft,justifycenter,justifyright,separator,bullist,numlist,separator,outdent,indent,blockquote,separator,link,unlink,separator,code",
