Joruri::Application.routes.draw do
  ...
  match '_admin/_files/*path'           => 'sns/admin/files#down'
  match '_admin/_photos/*path'           => 'sns/admin/photos#down'
...
#  match '_admin'                 => 'webdb/admin/tables#index'
  match '_admin'                 => 'sns/admin/profiles#index'
  match '_admin/profile/:id'     => 'sns/admin/profiles#show'
 #  match '_admin'                 => 'sys/admin/front#index'
  ...
  match '_admin/api/profile'     => 'sns/service/profiles#receive'
